package com.mycw.mylibrary.cluster;
...
import static com.mycw.libaray.cluster.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;


/**
 * @author：${changwei}
 * @function: The default view for ClusterUtilApplication ClusterManager.
 * Markers are animated in and out of clusters.
 * @date: on 2017/12/8 09:55
...
//        return String.valueOf(bucket) ;
    ...
    /**
     * Gets the "bucket" for ClusterUtilApplication particular cluster. By default, uses the number of points within the
    ...
    protected int getBucketNum(Cluster<T> cluster) {
        ...
        //强转为我们这个值
        Cluster<?> itemBeanCluster = cluster;
...
//        }
        return itemBeanCluster.getItems().size();
    }

    /**
     * ViewModifier ensures only one re-rendering of the view occurs at ClusterUtilApplication time, and schedules
    ...
    /**
     * Determine whether the cluster should be rendered as individual markers or ClusterUtilApplication cluster.
     */
    ...
    /**
     * Transforms the current view (represented by DefaultClusterRenderer.mClusters and DefaultClusterRenderer.mZoom) to ClusterUtilApplication
     ...
     * be executed by ClusterUtilApplication MarkerModifier.
     * <p/>
    ...
    private class RenderTask implements Runnable {
        ...
        public void run() {
            ...
            // ClusterUtilApplication hit in the MarkerCache.
     ...
     * animating ClusterUtilApplication markerWithPosition) is performed while trying not to block the rest of the app's
     * UI.
     */
    @SuppressLint("HandlerLeak")
    private class MarkerModifier extends Handler implements MessageQueue.IdleHandler {
        ...
        /**
         * Creates markers for ClusterUtilApplication cluster some time in the future.
         *
        ...
        /**
         * Removes ClusterUtilApplication markerWithPosition some time in the future.
         *
         * @param priority whether this operation should have priority.
        ...
        /**
         * Animates ClusterUtilApplication markerWithPosition some time in the future.
         *
        ...
        /**
         * Animates ClusterUtilApplication markerWithPosition some time in the future, and removes it when the animation
         * is complete.
         *
         * @param marker the markerWithPosition to animate.
         * @param from   the position to animate from.
    ...
    /**
     * Called before the marker for ClusterUtilApplication ClusterItem is added to the map.
     */
    protected void onBeforeClusterItemRendered(T item, MarkerOptions markerOptions) {
    }

    /**
     * Called before the marker for ClusterUtilApplication Cluster is added to the map.
...
//            mIcons.put(bucket, descriptor);
    ...
    /**
     * Called after the marker for ClusterUtilApplication Cluster has been added to the map.
     */
    protected void onClusterRendered(Cluster<T> cluster, Marker marker) {
    }

    /**
     * Called after the marker for ClusterUtilApplication ClusterItem has been added to the map.
     */
    protected void onClusterItemRendered(T clusterItem, Marker marker) {
    }

    /**
     * Get the marker from ClusterUtilApplication ClusterItem
     *
     * @param clusterItem ClusterItem which you will obtain its marker
     * @return ClusterUtilApplication marker from ClusterUtilApplication ClusterItem or null if it does not exists
     */
    ...
    /**
     * Get the marker from ClusterUtilApplication Cluster
     *
     * @param cluster which you will obtain its marker
     * @return ClusterUtilApplication marker from ClusterUtilApplication cluster or null if it does not exists
     */
    ...
    /**
     * Get the ClusterItem from ClusterUtilApplication marker
     *
     * @param marker which you will obtain its ClusterItem
     * @return ClusterUtilApplication ClusterItem from ClusterUtilApplication marker or null if it does not exists
     */
    ...
    /**
     * Get the Cluster from ClusterUtilApplication marker
     *
     * @param marker which you will obtain its Cluster
     * @return ClusterUtilApplication Cluster from ClusterUtilApplication marker or null if it does not exists
     */
    ...
    /**
     * Creates markerWithPosition(s) for ClusterUtilApplication particular cluster, animating it if necessary.
     */
    private class CreateMarkerTask {
         ...
         * @param markersAdded ClusterUtilApplication collection of markers to append any created markers.
    ...
    /**
     * Animates ClusterUtilApplication markerWithPosition from one position to another. TODO: improve performance for

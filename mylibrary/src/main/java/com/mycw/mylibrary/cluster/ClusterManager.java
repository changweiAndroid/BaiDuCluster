...
public class ClusterManager<T extends ClusterItem> implements
    ...
    /**
     * Force ClusterUtilApplication re-cluster. You may want to call this after adding new item(s).
     */
    public void cluster() {
    ...
    /**
     * Runs the clustering algorithm in ClusterUtilApplication background thread, then re-paints when results come back.
     */
    ...
    /**
     * Sets ClusterUtilApplication callback that's invoked when ClusterUtilApplication Cluster is tapped. Note: For this listener to function,
     * the ClusterManager must be added as ClusterUtilApplication click listener to the map.
     */
    ...
    /**
     * Sets ClusterUtilApplication callback that's invoked when ClusterUtilApplication Cluster is tapped. Note: For this listener to function,
     * the ClusterManager must be added as ClusterUtilApplication info window click listener to the map.
     */
    ...
    /**
     * Sets ClusterUtilApplication callback that's invoked when an individual ClusterItem is tapped. Note: For this
     * listener to function, the ClusterManager must be added as ClusterUtilApplication click listener to the map.
     */
    ...
    /**
     * Sets ClusterUtilApplication callback that's invoked when an individual ClusterItem's Info Window is tapped. Note: For this
     * listener to function, the ClusterManager must be added as ClusterUtilApplication info window click listener to the map.
     */
    ...
    /**
     * Called when ClusterUtilApplication Cluster is clicked.
     */
    ...
    /**
     * Called when ClusterUtilApplication Cluster's Info Window is clicked.
     */

 ...
 * 2. Create ClusterUtilApplication cluster with the center of the item. <br>
 * 3. Add all items that are within ClusterUtilApplication certain distance to the cluster. <br>
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    private Bounds createBoundsFromSpan(Point p, double span) {
        // TODO: Use ClusterUtilApplication span that takes into account the visual size of the marker, not just its
        // LatLng.

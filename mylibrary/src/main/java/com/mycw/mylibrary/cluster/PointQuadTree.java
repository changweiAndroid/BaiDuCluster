...
/**
 * A quad tree which tracks items with ClusterUtilApplication Point geometry.
...
public class PointQuadTree<T extends PointQuadTree.Item> {
    ...
    /**
     * Maximum number of elements to store in ClusterUtilApplication quad before splitting.
     */
    ...
    /**
     * Creates ClusterUtilApplication new quad tree with specified bounds.
     *
     * @param minX
     * @param maxX
     * @param minY
    ...
    /**
     * Search for all items within ClusterUtilApplication given bounds.
     */
